...
export const translations: Record<Language, TranslationDict> = {
  vi: {
    ...
    noOpenPositions: 'Chưa có vị thế nào đang mở. Nhấn BUY / SELL trên Quick Trade để vào lệnh.',
    noPendingOrders: 'Không có lệnh chờ nào.',
    noHistory: 'Chưa có giao dịch nào hoàn tất.',
    symbol: 'Tài sản',
    side: 'Loại',
    lot: 'Lot',
    entryPrice: 'Giá vào',
    ...
    realizedPnL: 'Lợi nhuận ròng (PnL)',
    actions: 'Hành động',
    setBE: 'Set BE',
    close50: 'Cắt 50%',
    editSLTP: 'Sửa SL/TP',
    closePosition: 'Đóng vị thế',
    tagStrategy: 'Gắn Tag Chiến thuật (Setup)',
    psychologyNote: 'Ghi chú tâm lý',
    saveChanges: 'Lưu thay đổi',
    cancel: 'Hủy',

    analyticsTitle: 'Báo cáo & Thống kê Định lượng (Quantitative Analytics)',
    overviewTab: 'Tổng quan & Chỉ số',
    monteCarloTab: 'Mô phỏng Monte Carlo (1,000 chu kỳ)',
    heatmapTab: 'Heatmap Lợi nhuận theo Giờ/Thứ',
    exportCSV: 'Xuất CSV Lịch sử',
    equityGrowth: 'Biểu đồ Tăng trưởng Vốn (Equity / Balance Growth)',
  ...
  en: {
    ...
    tagStrategy: 'Strategy Tag (Setup)',
    ...
    monteCarloTab: 'Monte Carlo Simulation (1,000 runs)',
    heatmapTab: 'Day & Hourly Profit Heatmap',
    ...
    monteCarloDesc: 'Monte Carlo simulation randomizes the sequence of your executed trades 1,000 times to stress-test your strategy under adverse market scenarios.',
    medianProfit: 'Median Profit',
    worstCaseDD: 'Worst-case Drawdown',
    percentile95DD: '95th Percentile Max DD',
    riskOfRuin: 'Risk of Ruin (>50% DD)',
    heatmapDesc: 'PnL and Win Rate distribution across Trading Hours (UTC) & Weekdays:',

    aiStudioTitle: 'AI Strategy Studio & Sandbox Runner',
    promptPlaceholder: 'Describe your trading strategy in plain text (e.g., EMA 20 cross EMA 50 with RSI < 35 pullback)...',
